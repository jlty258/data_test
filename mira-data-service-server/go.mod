...
// 使用本地 vendor 目录中的依赖包
replace chainweaver.org.cn/chainweaver/mira/mira-common => /root/vendor/chainweaver.org.cn/chainweaver/mira/mira-common

replace chainweaver.org.cn/chainweaver/mira/mira-ida-access-service => /root/vendor/chainweaver.org.cn/chainweaver/mira/mira-ida-access-service
